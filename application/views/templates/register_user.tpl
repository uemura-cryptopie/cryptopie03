						...
						<div class="panel-body form-body">
							...
							<div class="form-group">
								...
								<div class="form-inline col-md-8 col-sm-8">
									<input type="text" class="form-control input -col-2" placeholder="苗字" name="name_sei" value="{$data.dataInsert.family_name|escape|default:''}">
									<input type="text" class="form-control input -col-2" placeholder="名前" name="name_mei" value="{$data.dataInsert.first_name|escape|default:''}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="form-inline col-md-8 col-sm-8">
									<input type="text" class="form-control input -col-2" placeholder="ミョウジ" name="name_sei_kana" value="{$data.dataInsert.family_name_kana|escape|default:''}">
									<input type="text" class="form-control input -col-2" placeholder="ナマエ" name="name_mei_kana" value="{$data.dataInsert.first_name_kana|escape|default:''}">
								</div>
							</div>
							...
							<div class="js_addressBlock" style="display: block;">
								<div class="form-group">
									...
									<div class="form-inline col-md-8 col-sm-8">
										<!-- zip 1 -->
										<input type="text" name="zip1" class="form-control input -col-4 js_numOnry size_post" maxlength="3" id="user_zip1" pattern="\d*" value="{if $data.dataInsert.post1 != '0'}{$data.dataInsert.post1|escape|default:''}{/if}"><span>－</span>
										<!-- zip 2 -->
										<input type="text" name="zip2" class="form-control input -col-4 js_numOnry size_post" maxlength="4" id="user_zip2" pattern="\d*" value="{if $data.dataInsert.post2 != '0'}{$data.dataInsert.post2|escape|default:''}{/if}">
										<!-- button zip -->
								...
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8">
										<input type="text" name="adr2" maxlength="30" class="form-control input" id="city" placeholder="例）新宿区" value="{$data.dataInsert.city|escape|default:''}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8">
										<input type="text" name="adr3" class="form-control input" id="address1" maxlength="40" placeholder="例）○○○1-2-3" value="{$data.dataInsert.address|escape|default:''}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8">
										<input type="text" name="adr4" class="form-control input" maxlength="40" placeholder="例）メゾンドハイツ105" value="{$data.dataInsert.building|escape|default:''}">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<select class="select form-control m-b-10" name="residentialForm">
										<option value="">選択してください</option>
										{foreach from=$data['residentialForm'] item=item key=key}
											<option value="{$key}"{if $key == $data.dataInsert.home_type|escape|default:''} selected="selected"{/if}>{$item}</option>
										{/foreach}
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<select class="select form-control m-b-10" name="residenceYears">
										<option value="">選択してください</option>
										{foreach from=$data['residenceYears'] item=item key=key}
											<option value="{$key}"{if $key == $data.dataInsert.stay_year|escape|default:''} selected="selected"{/if}>{$item}</option>
										{/foreach}
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<select class="select form-control m-b-10" name="employmentSystem" id="office_select">
										<option value="">選択してください</option>
										{foreach from=$data['employmentSystem'] item=item key=key}
											<option value="{$key}"{if $key == $data.dataInsert.job|escape|default:''} selected="selected"{/if}>{$item}</option>
										{/foreach}
									</select>
								</div>
							</div>
							...
							<div class="officeArea" id="js_officeArea">
								...
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8">
										<input type="text" class="form-control" name="officeName" value="{$data.dataInsert.job_name|escape|default:''}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="form-inline col-md-8 col-sm-8">
										<input type="text" name="officeZip1" class="form-control input -col-4 js_numOnry size_post" maxlength="3" id="user_zip1_office" pattern="\d*" value="{if $data.dataInsert.job_post1 != '0'}{$data.dataInsert.job_post1|escape|default:''}{/if}"><span>－</span>
										<input type="text" name="officeZip2" class="form-control input -col-4 js_numOnry size_post" maxlength="4" id="user_zip2_office" pattern="\d*" value="{if $data.dataInsert.job_post2 != '0'}{$data.dataInsert.job_post2|escape|default:''}{/if}">
								...
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8">
										<input type="text" class="form-control" name="officeAddress" id="address_office" value="{$data.dataInsert.job_address|escape|default:''}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="form-inline col-md-8 col-sm-8">
										<input type="text" class="form-control input -col-tel" name="officeTel1" maxlength="5" value="{if $data.dataInsert.job_tel1 != '0'}{$data.dataInsert.job_tel1|escape|default:''}{/if}"><span>－</span>
										<input type="text" class="form-control input -col-tel" name="officeTel2" maxlength="4" value="{if $data.dataInsert.job_tel2 != '0'}{$data.dataInsert.job_tel2|escape|default:''}{/if}"><span>－</span>
										<input type="text" class="form-control input -col-tel" name="officeTel3" maxlength="4" value="{if $data.dataInsert.job_tel3 != '0'}{$data.dataInsert.job_tel3|escape|default:''}{/if}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8">
										<select class="select form-control m-b-10" name="serviceLength">
											<option value="">選択してください</option>
											{foreach from=$data['serviceLength'] item=item key=key}
												<option value="{$key}"{if $key == $data.dataInsert.job_year|escape|default:''} selected="selected"{/if}>{$item}</option>
											{/foreach}
										</select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8">
										<select class="select form-control m-b-10" name="annualIncome">
											<option value="">選択してください</option>
											{foreach from=$data['annualIncome'] item=item key=key}
												<option value="{$key}"{if $key == $data.dataInsert.guarantee|escape|default:''} selected="selected"{/if}>{$item}</option>
											{/foreach}
										</select>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<select class="select form-control m-b-10" name="borrowing">
										<option value="">選択してください</option>
										{foreach from=$data['borrowing'] item=item key=key}
											<option value="{$key}"{if $key == $data.dataInsert.debt1|escape|default:''} selected="selected"{/if}>{$item}</option>
										{/foreach}
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<select class="select form-control m-b-10" name="paymentOverdue">
										<option value="">選択してください</option>
										{foreach from=$data['paymentOverdue'] item=item key=key}
											<option value="{$key}"{if $key == $data.dataInsert.debt2|escape|default:''} selected="selected"{/if}>{$item}</option>
										{/foreach}
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<select class="select form-control m-b-10" name="familyStructure">
										<option value="">選択してください</option>
										{foreach from=$data['familyStructure'] item=item key=key}
											<option value="{$key}"{if $key == $data.dataInsert.famiry|escape|default:''} selected="selected"{/if}>{$item}</option>
										{/foreach}
									</select>
								</div>
							</div>
								...
								<div class="col-md-8 col-sm-8">
									...
									<div>
										<select class="select form-control m-b-10" name="investableAssets">
											<option value="">選択してください</option>
											{foreach from=$data['investableAssets'] item=item key=key}
												<option value="{$key}"{if $key == $data.dataInsert.investment_asset|escape|default:''} selected="selected"{/if}>{$item}</option>
											{/foreach}
										</select>
									</div>
									...
									<div>
										{foreach from=$data['investableAssetsRadio'] item=item key=key}
											<label class="checkbox-inline radio">
												<input type="radio" name="investableAssets_radio" class="input_radio" value="{$key}"{if $key == $data.dataInsert.investment_asset_flag|escape|default:''} checked="checked"{/if}>
												<span>{$item}</span>
											</label>
										{/foreach}
									</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<select class="select form-control m-b-10" name="select_01">
										<option value="">選択してください</option>
										{foreach from=$data['select01'] item=item key=key}
											<option value="{$key}"{if $key == $data.dataInsert.income|escape|default:''} selected="selected"{/if}>{$item}</option>
										{/foreach}
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8">
									<select class="select form-control m-b-10" name="select_02">
										<option value="">選択してください</option>
										{foreach from=$data['select02'] item=item key=key}
									...
									<input type="text" class="form-control" name="select_02_other" value="{$data.dataInsert.subscription_text|escape|default:''}" maxlength="50">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<select class="select form-control m-b-10" name="select_03">
												<option value="">選択してください</option>
												{foreach from=$data['select03'] item=item key=key}
													<option value="{$key}"{if $key == $data.dataInsert.fx_trade|escape|default:''} selected="selected"{/if}>{$item}</option>
												{/foreach}
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<select class="select form-control m-b-10" name="select_04">
												<option value="">選択してください</option>
												{foreach from=$data['select04'] item=item key=key}
													<option value="{$key}"{if $key == $data.dataInsert.cash_trade|escape|default:''} selected="selected"{/if}>{$item}</option>
												{/foreach}
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<select class="select form-control m-b-10" name="select_05">
												<option value="">選択してください</option>
												{foreach from=$data['select05'] item=item key=key}
													<option value="{$key}"{if $key == $data.dataInsert.credit_trade|escape|default:''} selected="selected"{/if}>{$item}</option>
												{/foreach}
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<select class="select form-control m-b-10" name="select_06">
												<option value="">選択してください</option>
												{foreach from=$data['select06'] item=item key=key}
													<option value="{$key}"{if $key == $data.dataInsert.option_trade|escape|default:''} selected="selected"{/if}>{$item}</option>
												{/foreach}
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<select class="select form-control m-b-10" name="select_07">
												<option value="">選択してください</option>
												{foreach from=$data['select07'] item=item key=key}
													<option value="{$key}"{if $key == $data.dataInsert.item_trade|escape|default:''} selected="selected"{/if}>{$item}</option>
												{/foreach}
											</select>
										</div>
									</div>
							...
							<div class="agreeSelect">
								...
								<div class="form-group -bg_even">
									...
									<div class="col-md-3">
										<label class="checkbox-inline radio">
											<input type="radio" name="agree_2" value='1' class="input_radio" {if $data.dataInsert.agree_2 == '1'} checked="checked"{/if}>
											<span>はい</span>
										</label>
										<label class="checkbox-inline radio">
											<input type="radio" name="agree_2" value='2' class="input_radio" {if $data.dataInsert.agree_2 == '2'} checked="checked"{/if}>
											<span>いいえ</span>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<label class="checkbox-inline radio">
											<input type="radio" name="agree_3" value='1' class="input_radio" {if $data.dataInsert.agree_3 == '1'} checked="checked"{/if}>
											<span>はい</span>
										</label>
										<label class="checkbox-inline radio">
											<input type="radio" name="agree_3" value='2' class="input_radio" {if $data.dataInsert.agree_3 == '2'} checked="checked"{/if}>
											<span>いいえ</span>
										</label>
									</div>
								</div>
