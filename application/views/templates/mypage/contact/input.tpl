		...
		<aside class="right-side">
			...
			<section class="content">
				...
				<section class="panel panel-fixed">
					<form name="sentMessage" id="applicationForm" class="form-horizontal" action="{$base_url}mypage/contact/register/" method="post">
						<div class="panel-body">
							<h2 class="heading heading-default heading-h2">お問い合わせ</h2>
