	...
	<section id="content">
		<div class="container">
			<div class="row form-container">
				...
				<!-- Form itself -->
				<form name="sentMessage" id="applicationForm" class="form-horizontal" action="{$base_url}{$controller}/hojin-conf/" method="post">
					<section class="panel">
						<header class="panel-heading form-heading">お客様情報のご登録</header>
						<div class="panel-body form-body">
							<h3 class="form-intitle">お客様情報</h3>
							<div class="form-group">
								<label class="col-md-3 col-sm-4 control-label">法人名（漢字）<span class="form-icon-required">必須</span></label>
								<div class="col-md-9 col-sm-8">
									<input type="text" class="form-control input" placeholder="" name="corp_name" value="{$params.corp_name|escape|default:''}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 col-sm-4 control-label">法人名（フリガナ）<span class="form-icon-required">必須</span></label>
								<div class="col-md-9 col-sm-8">
									<input type="text" class="form-control input" placeholder="" name="corp_name_kana" value="{$params.corp_name_kana|escape|default:''}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 col-sm-4 control-label">代表者名（漢字）<span class="form-icon-required">必須</span></label>
								<div class="form-inline col-md-9 col-sm-8">
									<input type="text" class="form-control input -col-2" placeholder="苗字" name="ceo_name" value="{$params.ceo_name|escape|default:''}">
									<input type="text" class="form-control input -col-2" placeholder="名前" name="ceo_first_name" value="{$params.ceo_first_name|escape|default:''}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 col-sm-4 control-label">代表者名（フリガナ）<span class="form-icon-required">必須</span></label>
								<div class="form-inline col-md-9 col-sm-8">
									<input type="text" class="form-control input -col-2" placeholder="ミョウジ" name="ceo_name_kana" value="{$params.ceo_name_kana|escape|default:''}">
									<input type="text" class="form-control input -col-2" placeholder="ナマエ" name="ceo_first_name_kana" value="{$params.ceo_first_name_kana|escape|default:''}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 col-sm-4 control-label">担当者名（漢字）<span class="form-icon-required">必須</span></label>
								<div class="form-inline col-md-9 col-sm-8">
									<input type="text" class="form-control input -col-2" placeholder="苗字" name="pre_name" value="{$params.pre_name|escape|default:''}">
									<input type="text" class="form-control input -col-2" placeholder="名前" name="pre_first_name" value="{$params.pre_first_name|escape|default:''}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 col-sm-4 control-label">担当者名（フリガナ）<span class="form-icon-required">必須</span></label>
								<div class="form-inline col-md-9 col-sm-8">
									<input type="text" class="form-control input -col-2" placeholder="ミョウジ" name="pre_name_kana" value="{$params.pre_name_kana|escape|default:''}">
									<input type="text" class="form-control input -col-2" placeholder="ナマエ" name="pre_first_name_kana" value="{$params.pre_first_name_kana|escape|default:''}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 col-sm-4 control-label">設立年月日<span class="form-icon-required">必須</span></label>
								<div class="form-inline col-md-9 col-sm-8">
...
$(function(){
	...
	var checkOverlapUser  = new appForm.checkOverlapUser({
		url : "{$base_url}{$controller}/is-duplicate-corp/"
	});
	...
	var validator = $("#applicationForm").validate({
		...
		rules : { // バリデーションルールの設定
			...
			"corp_name_kana"      : { required: true, check_num_kana: true },
			"ceo_name"            : { required: true, check_symbol: true },
			"ceo_first_name"      : { required: true, check_symbol: true },
			"ceo_name_kana"       : { required: true, check_num_kana: true },
			"ceo_first_name_kana" : { required: true, check_num_kana: true },
			"pre_name"            : { required: true, check_symbol: true },
			"pre_first_name"      : { required: true, check_symbol: true },
			"pre_name_kana"       : { required: true, check_num_kana: true },
			"pre_first_name_kana" : { required: true, check_num_kana: true },
			"year"                : { required: true },
			"month"               : { required: true },
			"day"                 : { required: true },
		...
		messages: {
			...
			"corp_name_kana"      : { required: "「法人名のフリガナ」を入力してください", check_num_kana:"カタカナか半角数字で入力してください" },
			...
			"ceo_name_kana"       : { required: "「代表者名のフリガナ」を入力してください", check_num_kana:"カタカナか半角数字で入力してください" },
			"ceo_first_name_kana" : { required: "「代表者名のフリガナ」を入力してください", check_num_kana:"カタカナか半角数字で入力してください" },
			"pre_name"            : { required: "「担当者名」を入力してください", check_symbol:"使用できない記号が含まれています" },
			"pre_first_name"      : { required: "「担当者名」を入力してください", check_symbol:"使用できない記号が含まれています" },
			"pre_name_kana"       : { required: "「担当者名のフリガナ」を入力してください", check_num_kana:"カタカナか半角数字で入力してください" },
			"pre_first_name_kana" : { required: "「担当者名のフリガナ」を入力してください", check_num_kana:"カタカナか半角数字で入力してください" },
