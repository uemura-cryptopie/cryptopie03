	...
	<section id="content">
		<div class="container">
			<div class="row form-container">
				...
				<!-- Form itself -->
				<form name="sentMessage" id="applicationForm" class="form-horizontal" action="{$base_url}{$controller}/hojin-password/" method="post">
					<section class="panel">
						...
						<div class="panel-body form-body">
							...
							<div class="form-group form-conf">
								<label class="col-md-3 col-sm-4 control-label">法人名（漢字）</label>
								<div class="col-md-9 col-sm-8">
									{$params.corp_name|escape|default:''}
								</div>
							</div>
							<div class="form-group form-conf">
								<label class="col-md-3 col-sm-4 control-label">法人名（フリガナ）</label>
								<div class="col-md-9 col-sm-8">
									{$params.corp_name_kana|escape|default:''}
								</div>
							</div>
							<div class="form-group form-conf">
								<label class="col-md-3 col-sm-4 control-label">代表者名（漢字）</label>
								<div class="col-md-9 col-sm-8">
									{$params.ceo_name|escape|default:''} {$params.ceo_first_name|escape|default:''}
								</div>
							</div>
							<div class="form-group form-conf">
								<label class="col-md-3 col-sm-4 control-label">代表者名（フリガナ）</label>
								<div class="col-md-9 col-sm-8">
									{$params.ceo_name_kana|escape|default:''} {$params.ceo_first_name_kana|escape|default:''}
								</div>
							</div>
							<div class="form-group form-conf">
								<label class="col-md-3 col-sm-4 control-label">担当者名（漢字）</label>
								<div class="col-md-9 col-sm-8">
									{$params.pre_name|escape|default:''} {$params.pre_first_name|escape|default:''}
								</div>
							</div>
							<div class="form-group form-conf">
								<label class="col-md-3 col-sm-4 control-label">担当者名（フリガナ）</label>
								<div class="col-md-9 col-sm-8">
									{$params.pre_name_kana|escape|default:''} {$params.pre_first_name_kana|escape|default:''}
								</div>
							</div>
							<div class="form-group form-conf">
								<label class="col-md-3 col-sm-4 control-label">設立年月日</label>
								<div class="col-md-9 col-sm-8">
