...
class Contact extends MY_Controller {
	...
	public function index()
	{
		...
		redirect(base_url() . "{$this->controller}/input/");
	}
	...
	public function input()
	{
		...
		$this->tpl('other/contact/input.tpl');
	}
	...
	public function register()
	{
		if ($this->lib_contact->validateInputs()) {
			...
			$this->lib_contact->sendMail(); // メール送信(問合せ本人&BCC)
			redirect(base_url() . "{$this->controller}/complete/");
		} else {
			// 再入力
	...
	public function complete()
	{
		...
		$this->assign('back_url', $back_url);
		$this->tpl('other/contact/complete.tpl');
	}
